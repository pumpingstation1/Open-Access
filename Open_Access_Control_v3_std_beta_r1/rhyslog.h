		...
		case '1':
			...
			switch(logcode.l3) {					
				...
				case '2':							// Failsafe Locking Mechanism
													// uses l4 for failsafe time hours
													// uses l5 for failsafe time minutes
					Serial.print(" Bedtime Locking Mechanism set for:");
					Serial.print(logcode.l4);
					Serial.print(":");
					Serial.print(logcode.l5);
